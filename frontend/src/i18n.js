...
const resources = {
  en: {
    translation: {
      ...
      settings: { title: 'Integrations', ai_provider: 'AI provider', ai_model: 'Model', ai_key: 'API key (optional)', ai_key_hint: 'Leave blank to use the built-in engine. Add your own key anytime.', key_set: 'A key is configured', n8n: 'n8n webhook URL', n8n_hint: 'Point to your n8n / ZimaBoard orchestration endpoint.', save: 'Save settings', saved: 'Settings saved' },
  ...
  fr: {
    translation: {
      ...
      settings: { title: 'Int\u00e9grations', ai_provider: 'Fournisseur IA', ai_model: 'Mod\u00e8le', ai_key: 'Cl\u00e9 API (optionnelle)', ai_key_hint: 'Laissez vide pour utiliser le moteur int\u00e9gr\u00e9. Ajoutez votre cl\u00e9 quand vous voulez.', key_set: 'Une cl\u00e9 est configur\u00e9e', n8n: 'URL webhook n8n', n8n_hint: 'Pointez vers votre orchestration n8n / ZimaBoard.', save: 'Enregistrer', saved: 'Param\u00e8tres enregistr\u00e9s' },
